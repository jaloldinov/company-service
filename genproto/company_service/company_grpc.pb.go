...
type CompanyServiceClient interface {
	Create(ctx context.Context, in *CreateCompany, opts ...grpc.CallOption) (*Company, error)
	...
	Update(ctx context.Context, in *Company, opts ...grpc.CallOption) (*CompanyResult, error)
	Delete(ctx context.Context, in *CompanyId, opts ...grpc.CallOption) (*CompanyResult, error)
}
...
func (c *companyServiceClient) Create(ctx context.Context, in *CreateCompany, opts ...grpc.CallOption) (*Company, error) {
	out := new(Company)
...
func (c *companyServiceClient) Update(ctx context.Context, in *Company, opts ...grpc.CallOption) (*CompanyResult, error) {
	out := new(CompanyResult)
...
func (c *companyServiceClient) Delete(ctx context.Context, in *CompanyId, opts ...grpc.CallOption) (*CompanyResult, error) {
	out := new(CompanyResult)
...
type CompanyServiceServer interface {
	Create(context.Context, *CreateCompany) (*Company, error)
	Get(context.Context, *CompanyId) (*Company, error)
	GetAll(context.Context, *GetAllCompanyRequest) (*GetAllCompanyResponse, error)
	Update(context.Context, *Company) (*CompanyResult, error)
	Delete(context.Context, *CompanyId) (*CompanyResult, error)
...
func (UnimplementedCompanyServiceServer) Create(context.Context, *CreateCompany) (*Company, error) {
...
func (UnimplementedCompanyServiceServer) Update(context.Context, *Company) (*CompanyResult, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedCompanyServiceServer) Delete(context.Context, *CompanyId) (*CompanyResult, error) {
