...
type ProfessionServiceClient interface {
	...
	Update(ctx context.Context, in *Profession, opts ...grpc.CallOption) (*Result, error)
	Delete(ctx context.Context, in *ProfessionId, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *professionServiceClient) Get(ctx context.Context, in *ProfessionId, opts ...grpc.CallOption) (*Profession, error) {
	out := new(Profession)
	err := c.cc.Invoke(ctx, "/position_service.ProfessionService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *professionServiceClient) Update(ctx context.Context, in *Profession, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
func (c *professionServiceClient) Delete(ctx context.Context, in *ProfessionId, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
type ProfessionServiceServer interface {
	...
	Update(context.Context, *Profession) (*Result, error)
	Delete(context.Context, *ProfessionId) (*Result, error)
...
func (UnimplementedProfessionServiceServer) Update(context.Context, *Profession) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedProfessionServiceServer) Delete(context.Context, *ProfessionId) (*Result, error) {
...
func _ProfessionService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/position_service.ProfessionService/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
